...
const checks = [
  ...
  ["english popup context", "index.html", /Extension popup preview[\s\S]*small control screen/],
  ...
  ["english popup workflow", "index.html", /Why it matters[\s\S]*One small screen for the action users need most\./],
  ...
  ["japanese popup context", "ja/index.html", /ポップアップ画面プレビュー[\s\S]*小さな操作画面/],
  ...
  ["japanese popup workflow", "ja/index.html", /なぜ便利か[\s\S]*一番よく使う操作を、小さい画面に集約。/],
