...
const checks = [
  ["english title", "index.html", /<title>Tab Relief \| Keep your tabs\. Lighten Chrome\.<\/title>/],
  ["english language switch", "index.html", /data-language-choice="ja"[\s\S]*日本語/],
  ["english hero", "index.html", /Keep your tabs\. Lighten Chrome\./],
  ["english install CTA", "index.html", /View install options/],
  ["english product proof", "index.html", /800 MB[\s\S]*lighter now[\s\S]*16 sleeping \/ 8 ready/],
  ["english popup action", "index.html", /Sleep inactive tabs[\s\S]*Active work stays awake/],
  ["english close feature", "index.html", /Close matching tabs[\s\S]*confirm before closing/],
  ...
  ["japanese title", "ja/index.html", /<title>Tab Relief \| タブは残す。Chromeは軽く。<\/title>/],
  ["japanese language switch", "ja/index.html", /data-language-choice="en"[\s\S]*日本語/],
  ["japanese hero", "ja/index.html", /タブは残す。Chromeは軽く。/],
  ["japanese install CTA", "ja/index.html", /インストール状況を見る/],
  ["japanese product proof", "ja/index.html", /800 MB[\s\S]*軽量化目安[\s\S]*休止中 16件 \/ 休止可能 8件/],
  ["japanese popup action", "ja/index.html", /未使用タブを休止[\s\S]*作業中はそのまま/],
  ["japanese close feature", "ja/index.html", /条件に合うタブを閉じる[\s\S]*閉じる前に確認できます/],
