...
const checks = [
  ...
  ["english popup context", "index.html", /Click the Tab Relief icon\. This popup opens\./],
  ...
  ["english popup workflow", "index.html", /From the popup[\s\S]*See the load\. Rest safe tabs\. Keep working\./],
  ...
  ["japanese popup context", "ja/index.html", /Tab Reliefアイコンを押すと、この画面が開きます。/],
  ...
  ["japanese popup workflow", "ja/index.html", /ポップアップでできること[\s\S]*重さを見て、安全なタブだけ休止。/],
